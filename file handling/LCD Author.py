...
samplefiledf = pd.read_excel(
    r'C:\Work\Work Related Details\GCC Testing Logic & SQL Queries\LCD\Backfill\ArticleDevbackfill_25thFeb_2.xlsx')
authordetailsdf = pd.read_excel(
    r'C:\Work\Work Related Details\GCC Testing Logic & SQL Queries\LCD\Backfill/LCD_Author_List.xlsx')
...
newdf2.to_excel("LCDArticleAuthor.xlsx", engine='xlsxwriter')
